...
export async function discoverDocumentsWithClaude(
  ...
  const prompt = [
    ...
    "Use only the provided query and provided context to infer good internet search directions.",
    "Web leads must be direct public URLs to likely relevant sites or pages.",
