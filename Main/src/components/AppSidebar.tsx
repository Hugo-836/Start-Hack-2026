...
import { GraduationCap, LayoutDashboard, MessageSquare, Milestone, Users, BookOpen, FolderOpen, UserCheck, Inbox } from "lucide-react";
...
const mentorItems = [
  ...
  { title: "Requests", url: "/mentor/requests", icon: Inbox },
